//
//  TDXDBlockScrollGoodsListComponent.m
//  TestScrollView
//
...
@interface TDXDBlockScrollGoodsListComponent () <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, assign) NSInteger count;
@end

@implementation TDXDBlockScrollGoodsListComponent
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"List: %ld", indexPath.row];
    return cell;
}
